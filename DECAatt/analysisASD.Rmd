---
title: "PCIT-CoS-Waitlist RCT Paper 1: DECA Attachment ASD"
author: "Nancy Briggs"
date: "05 JAN 2021"
output:
  html_document:
...
### DECA Attachment Adjusting for ASD {.tabset .tabset-fade .tabset-pills}
...
#  analysis
dat <- data %>%
  dplyr::select(id,group, asdcase, attach_1, attach_2, attach_3) %>%
  pivot_longer( cols = starts_with("attach_"), names_prefix = "attach_", 
                names_to="t", values_to="outcome") %>%
