...
write.csv(desctable,"desctable_asd_log.csv", row.names = TRUE)
...
There is no evidence that ASD moderates the 2-way group*time interaction (the 3-way interaction p=0.803). 
...
pvalue<0.05. We do  evidence that there is a difference in the change over from Baseline to Post amongst the groups, such that PCITT showed the largest change, then COSP then Waitlist.
