...
#data$fu_ccqe_mean[data$group==3] <- NA
...
scores increased for the PCITT group from Baseline to post (-.218), and decreased for COSP (0.027).
...
There is not as much change in PCITT(-0.074) as in COSP (-0.100).
