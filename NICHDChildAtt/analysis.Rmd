---
title: "PCIT-CoS-Waitlist RCT Paper 1: Child Attention (NICHD)"
author: "Nancy Briggs"
date: "06 June 2022"
output:
  html_document:
...
### Child Attention (NICHD {.tabset .tabset-fade .tabset-pills}
...
hist<-ggplot(p, aes(x=outcome) )+
  ...
  xlab("Observed Child Attention (NICHD)") +
  ylab("Frequency") +
...
There is almost no change in the PCITT group (0.0221), but an increase for COSP (-1.533) and Waitlist (-.810)
...
There is more change in PCITT(-2.172) than in COSP (-1.363).
