...
NOTE THIS SET OF RESULTS DOES NOT BOOTSTRAP.
...
fit_mixed <- lmer(outcome ~ group*time + (1 | id), dat)
...
s_groupdiffs %>%
  ...
  kable_styling() %>%
  add_footnote( c("Effect size scaled by pooled T1 SD of logged data", "ES 95% Bootstrapped Percentile CI limits","If you want a positive ES (and it is calculated as negative), be sure to switch the signs and positions of the lower and upper CIs."), notation = "symbol")
```
