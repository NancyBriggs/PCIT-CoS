---
title: "PCIT-CoS-Waitlist RCT Paper 1: DECA Self Regulation ASD"
author: "Nancy Briggs"
date: "05 JAN 2021"
output:
  html_document:
...
### DECA Self Regulation Adjusting for ASD {.tabset .tabset-fade .tabset-pills}
...
#  analysis
dat <- data %>%
  dplyr::select(id,group, asdcase, sr_1, sr_2, sr_3) %>%
  pivot_longer( cols = starts_with("sr_"), names_prefix = "sr_", 
                names_to="t", values_to="outcome") %>%
  mutate(time = ifelse(t == "1",  1,
                ifelse(t == "2", 2, 3))) 
