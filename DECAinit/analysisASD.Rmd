---
title: "PCIT-CoS-Waitlist RCT Paper 1: DECA Initiative ASD"
author: "Nancy Briggs"
date: "05 JAN 2021"
output:
  html_document:
...
### DECA Initiative Adjusting for ASD {.tabset .tabset-fade .tabset-pills}
...
#  analysis
dat <- data %>%
  dplyr::select(id,group, asdcase, init_1, init_2, init_3) %>%
  pivot_longer( cols = starts_with("init_"), names_prefix = "init_", 
                names_to="t", values_to="outcome") %>%
  mutate(time = ifelse(t == "1",  1,
                ifelse(t == "2", 2, 3))) 
...
There is no evidence that ASD moderates the 2-way group*time interaction the 3-way interaction (p=0.544). 
...
The increase is larger in PCITT than in COSP.
